"""
Module related to the different graphs in pre-Ten > Operator.
"""
...
FIRST_GRAPH = "Ten: NOK by Type per Operator"

def register_operator_callbacks(app):

    #############################################
    # 1st Graph : Ten. NOK by Type per Operator #
    #############################################
...
"""
    ###############################################
    # 2nd Graph : Ten: NOK (%) per Operator #
    ###############################################

    @app.callback(
        [
        Output('Ten: NOK (%) per Operator', 'figure'),
        Output('Ten: NOK (%) per Operator (bis)', 'figure'),
        ],
        [
    ...
    def update_2(selected_year, selected_week, operator_value, equipment_value, equipment_per_operator, shift_value, weekday_value):
        ...
        title = generate_title(input_values, "Ten: NOK (%) per Operator")
    ...
    #####################################################
    # 3rd Graph : Ten: NOK (%) in function of PCS #
    #####################################################

    @app.callback(
        [
        Output('Ten: NOK (%) in function of PCS', 'figure'),
        Output('Ten: NOK (%) in function of PCS (bis)', 'figure'),
        ],
        [
    ...
    def update_3(selected_year, selected_week, operator_value, equipment_value, shift_value, equipment_per_operator, weekday_value):
        input_values = {'Year': selected_year, 'Week': selected_week, 'Operator': operator_value,'Equipment': equipment_value, 'Shift': shift_value, 'Weekday': weekday_value, 'Equipments per Operator': equipment_per_operator}
        title = generate_title(input_values, "Ten: NOK (%) in function of PCS")
        ...
        return fig, fig
            ...
            dbc.Col([
                CustomCard([
                    dbc.Col(dcc.Graph(id='Ten: NOK (%) per Operator', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}), className='p-0', style={"flexGrow": "1"}),
                ...
                dbc.Modal([
                    ...
                    dbc.ModalBody(
                        CustomCard([
                            dcc.Graph(id='Ten: NOK (%) per Operator (bis)', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}, style={"flexGrow": "1"}),
        ...
        dbc.Row([
            ...
            dbc.Col([
                CustomCard([
                    dbc.Col(dcc.Graph(id='Ten: NOK (%) in function of PCS', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}), className='p-0', style={"flexGrow": "1"}),
                ...
                dbc.Modal([
                    ...
                    dbc.ModalBody(
                        CustomCard([
                            dcc.Graph(id='Ten: NOK (%) in function of PCS (bis)', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}, style={"margin": "auto", "display": "block"}),
