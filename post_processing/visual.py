...
from pp_load import load_df_visual
...
def register_visual_callbacks(app):
    ...
    ############################################
    # 1st Graph : Visual: NOK by Type per week #
    ############################################

    @app.callback(
        [
        Output('Visual: NOK by Type per week', 'figure'),
        Output('Visual: NOK by Type per week (bis)', 'figure')
        ],
        [
    ...
    def update_1(selected_year, selected_week, selected_operator, selected_equipment):
        ...
        title = generate_title(input_values, "Visual: NOK by Type per week")

        df_visual = load_df_visual(input_values)
        df_visual_type = extract_type(df_visual)

        filtered_df = filter_dataframe(df_visual, input_values)
        filtered_df_type = filter_dataframe(df_visual_type, input_values)
    ...
    ################################################
    # 2nd Graph : Visual: NOK by Type per Operator #
    ################################################

    @app.callback(
        [
        Output('Visual: NOK by Type per Operator', 'figure'),
        Output('Visual: NOK by Type per Operator (bis)', 'figure')
        ],
        [
    ...
    def update_2(selected_year, selected_week, selected_operator, selected_equipment):
        input_values = {'Year': selected_year, 'Week': selected_week, 'Operator': selected_operator, 'Equipment': selected_equipment}
        title = generate_title(input_values, "Visual: NOK by Type per Operator")
    ...
    ####################################################
    # 3rd Graph : Visual: NOK by Type per Collaborator #
    ####################################################

    @app.callback(
        [
        Output('Visual: NOK by Type per Collaborator', 'figure'),
        Output('Visual: NOK by Type per Collaborator (bis)', 'figure')
        ],
        [
    ...
    def update_3(selected_year, selected_week, selected_equipment):
        ...
        title = generate_title(input_values, "Visual: NOK by Type per Collaborator")
    ...
    #################################################
    # 4th Graph : Visual: NOK by Type per Equipment #
    #################################################

    @app.callback(
        [
        Output('Visual: NOK by Type per Equipment', 'figure'),
        Output('Visual: NOK by Type per Equipment (bis)', 'figure')
        ],
        [
    ...
    def update_4(selected_year, selected_week, selected_equipment, selected_operator):
        input_values = {'Year': selected_year, 'Week': selected_week, 'Equipment': selected_equipment, 'Operator': selected_operator}
        title = generate_title(input_values, "Visual: NOK by Type per Equipment")
    ...
    #########################################
    # 5th Graph : Visual: NOK per Type #
    #########################################

    @app.callback(
        [
        Output('Visual: NOK per Type', 'figure'),
        Output('Visual: NOK per Type (bis)', 'figure')
        ],
        [
    ...
    def update_5(selected_year, selected_week, selected_equipment):
        input_values = {'Year': selected_year, 'Week': selected_week, 'Equipment': selected_equipment}
        title = generate_title(input_values, "Visual: NOK per Type")
        
        df_dimensional = load_df_visual(input_values)
...
def visual_layout(operator_show):
    ...
    if operator_show:
        ...
        dbc.Row([               
            ...
            dbc.Col([
                CustomCard([
                    dbc.Col(dcc.Graph(id='Visual: NOK by Type per week', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}), className='p-0', style={"flexGrow": "1"}),
                ...
                dbc.Modal([
                    ...
                    dbc.ModalBody(
                        CustomCard([
                            dcc.Graph(id='Visual: NOK by Type per week (bis)', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}, style={"flexGrow": "1"}),
        ...
        dbc.Row([
            ...
            ################################################
            # 3rd Graph : Visual: NOK by Type per Operator #
            ################################################

            dbc.Col([
                CustomCard([
                    dbc.Col(dcc.Graph(id='Visual: NOK by Type per Operator', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}), className='p-0', style={"flexGrow": "1"}),
                ...
                dbc.Modal([
                    ...
                    dbc.ModalBody(
                        CustomCard([
                            dcc.Graph(id='Visual: NOK by Type per Operator (bis)', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}, style={"margin": "auto", "display": "block"}),
            ...
            ####################################################
            # 2nd Graph : Visual: NOK by Type per Collaborator #
            ####################################################

            dbc.Col([
                CustomCard([
                    dbc.Col(dcc.Graph(id='Visual: NOK by Type per Collaborator', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}), className='p-0', style={"flexGrow": "1"}),
                ...
                dbc.Modal([
                    ...
                    dbc.ModalBody(
                        CustomCard([
                            dcc.Graph(id='Visual: NOK by Type per Collaborator (bis)', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}, style={"flexGrow": "1"}),
        ...
        dbc.Row([
            ...
            dbc.Col([
                CustomCard([
                    dbc.Col(dcc.Graph(id='Visual: NOK by Type per Equipment', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}), className='p-0', style={"flexGrow": "1"}),
                ...
                dbc.Modal([
                    ...
                    dbc.ModalBody(
                        CustomCard([
                            dcc.Graph(id='Visual: NOK by Type per Equipment (bis)', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}, style={"flexGrow": "1"}),
            ...
            dbc.Col([
                CustomCard([
                    dbc.Col(dcc.Graph(id='Visual: NOK per Type', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}), className='p-0', style={"flexGrow": "1"}),
                ...
                dbc.Modal([
                    ...
                    dbc.ModalBody(
                        CustomCard([
                            dcc.Graph(id='Visual: NOK per Type (bis)', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}, style={"margin": "auto", "display": "block"}),
