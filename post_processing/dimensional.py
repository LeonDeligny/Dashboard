"""
Module related to the different graphs in Post Processing > Dimensional AQL.
...
from pp_load import load_df_dimensional
...
def register_dimensional_callbacks(app):

    #################################################
    # 1st Graph : Dimensional AQL: NOK by Type per week #
    #################################################

    @app.callback(
        [
        Output('Dimensional AQL: NOK by Type per week', 'figure'),
        Output('Dimensional AQL: NOK by Type per week (bis)', 'figure')
        ],
        [
    ...
    def update_1(selected_year, selected_week, selected_operator, selected_equipment):
        ...
        title = generate_title(input_values, "Dimensional AQL: NOK by Type per week")
        
        df_dimensional = load_df_dimensional(input_values)
        df_dimensional_type = extract_type(df_dimensional)

        filtered_df = filter_dataframe(df_dimensional, input_values)
    ...
    #########################################################
    # 2nd Graph : Dimensional AQL: NOK by Type per Collaborator #
    #########################################################

    @app.callback(
        [
        Output('Dimensional AQL: NOK by Type per Collaborator', 'figure'),
        Output('Dimensional AQL: NOK by Type per Collaborator (bis)', 'figure')
        ],
        [
    ...
    def update_2(selected_year, selected_week, selected_equipment):
        ...
        title = generate_title(input_values, "Dimensional AQL: NOK by Type per Collaborator")
    ...
    #####################################################
    # 3rd Graph : Dimensional AQL: NOK by Type per Operator #
    #####################################################

    @app.callback(
        [
        Output('Dimensional AQL: NOK by Type per Operator', 'figure'),
        Output('Dimensional AQL: NOK by Type per Operator (bis)', 'figure')
        ],
        [
    ...
    def update_3(selected_year, selected_week, selected_operator, selected_equipment):
        input_values = {'Year': selected_year, 'Week': selected_week, 'Operator': selected_operator, 'Equipment': selected_equipment}
        title = generate_title(input_values, "Dimensional AQL: NOK by Type per Operator")
    ...
    ######################################################
    # 4th Graph : Dimensional AQL: NOK by Type per Equipment #
    ######################################################

    @app.callback(
        [
        Output('Dimensional AQL: NOK by Type per Equipment', 'figure'),
        Output('Dimensional AQL: NOK by Type per Equipment (bis)', 'figure')
        ],
        [
    ...
    def update_4(selected_year, selected_week, selected_equipment):
        input_values = {'Year': selected_year, 'Week': selected_week, 'Equipment': selected_equipment}
        title = generate_title(input_values, "Dimensional AQL: NOK by Type per Equipment")
    ...
    #########################################
    # 5th Graph : Dimensional AQL: NOK per Type #
    #########################################

    @app.callback(
        [
        Output('Dimensional AQL: NOK per Type', 'figure'),
        Output('Dimensional AQL: NOK per Type (bis)', 'figure')
        ],
        [
    ...
    def update_5(selected_year, selected_week, selected_equipment):
        input_values = {'Year': selected_year, 'Week': selected_week, 'Equipment': selected_equipment}
        title = generate_title(input_values, "Dimensional AQL: NOK per Type")
...
def dimensional_layout(operator_show):
    ...
    if operator_show:
        ...
        dbc.Row([               
            ...
            dbc.Col([
                CustomCard([
                    dbc.Col(dcc.Graph(id='Dimensional AQL: NOK by Type per week', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}), className='p-0', style={"flexGrow": "1"}),
                ...
                dbc.Modal([
                    ...
                    dbc.ModalBody(
                        CustomCard([
                            dcc.Graph(id='Dimensional AQL: NOK by Type per week (bis)', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}, style={"flexGrow": "1"}),
        ...
        dbc.Row([
            ...
            dbc.Col([
                CustomCard([
                    dbc.Col(dcc.Graph(id='Dimensional AQL: NOK by Type per Operator', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}), className='p-0', style={"flexGrow": "1"}),
                ...
                dbc.Modal([
                    ...
                    dbc.ModalBody(
                        CustomCard([
                            dcc.Graph(id='Dimensional AQL: NOK by Type per Operator (bis)', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}, style={"margin": "auto", "display": "block"}),
            ...
            dbc.Col([
                CustomCard([
                    dbc.Col(dcc.Graph(id='Dimensional AQL: NOK by Type per Collaborator', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}), className='p-0', style={"flexGrow": "1"}),
                ...
                dbc.Modal([
                    ...
                    dbc.ModalBody(
                        CustomCard([
                            dcc.Graph(id='Dimensional AQL: NOK by Type per Collaborator (bis)', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}, style={"flexGrow": "1"}),
        ...
        dbc.Row([
            ...
            dbc.Col([
                CustomCard([
                    dbc.Col(dcc.Graph(id='Dimensional AQL: NOK by Type per Equipment', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}), className='p-0', style={"flexGrow": "1"}),
                ...
                dbc.Modal([
                    ...
                    dbc.ModalBody(
                        CustomCard([
                            dcc.Graph(id='Dimensional AQL: NOK by Type per Equipment (bis)', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}, style={"flexGrow": "1"}),
            ...
            dbc.Col([
                CustomCard([
                    dbc.Col(dcc.Graph(id='Dimensional AQL: NOK per Type', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}), className='p-0', style={"flexGrow": "1"}),
                ...
                dbc.Modal([
                    ...
                    dbc.ModalBody(
                        CustomCard([
                            dcc.Graph(id='Dimensional AQL: NOK per Type (bis)', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}, style={"margin": "auto", "display": "block"}),
