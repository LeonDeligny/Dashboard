"""
Module related to the different graphs in Post Processing > Deburring.
...
from pp_load import load_df_deburring
...
def register_deburring_callbacks(app):

    ###############################################
    # 1st Graph : Deburring: NOK by Type per week #
    ###############################################

    @app.callback(
        [
        Output('Deburring: NOK by Type per week', 'figure'),
        Output('Deburring: NOK by Type per week (bis)', 'figure')
        ],
        [
    ...
    def update_1(selected_year, selected_week, selected_operator, selected_equipment):
        ...
        title = generate_title(input_values, "Deburring: NOK by Type per week")
    ...
    #######################################################
    # 2nd Graph : Deburring: NOK by Type per Collaborator #
    #######################################################

    @app.callback(
        [
        Output('Deburring: NOK by Type per Collaborator', 'figure'),
        Output('Deburring: NOK by Type per Collaborator (bis)', 'figure')
        ],
        [
    ...
    def update_2(selected_year, selected_week, selected_equipment):
        ...
        title = generate_title(input_values, "Deburring: NOK by Type per Collaborator")
    ...
    ###################################################
    # 3rd Graph : Deburring: NOK by Type per Operator #
    ###################################################

    @app.callback(
        [
        Output('Deburring: NOK by Type per Operator', 'figure'),
        Output('Deburring: NOK by Type per Operator (bis)', 'figure')
        ],
        [
    ...
    def update_3(selected_year, selected_week, selected_equipment):
        input_values = {'Year': selected_year, 'Week': selected_week, 'Equipment': selected_equipment}
        title = generate_title(input_values, "Deburring: NOK by Type per Operator")
    ...
    ####################################################
    # 4th Graph : Deburring: NOK by Type per Equipment #
    ####################################################

    @app.callback(
        [
        Output('Deburring: NOK by Type per Equipment', 'figure'),
        Output('Deburring: NOK by Type per Equipment (bis)', 'figure')
        ],
        [
    ...
    def update_4(selected_year, selected_week, selected_operator):
        ...
        title = generate_title(input_values, "Deburring: NOK by Type per Equipment")
    ...
    #######################################
    # 5th Graph : Deburring: NOK per Type #
    #######################################

    @app.callback(
        [
        Output('Deburring: NOK per Type', 'figure'),
        Output('Deburring: NOK per Type (bis)', 'figure')
        ],
        [
    ...
    def update_5(selected_year, selected_week, selected_equipment):
        input_values = {'Year': selected_year, 'Week': selected_week, 'Equipment': selected_equipment}
        title = generate_title(input_values, "Deburring: NOK per Type")
        
        df_dimensional = load_df_deburring(input_values)
...
def deburring_layout(operator_show):
    ...
    if operator_show:
        ...
        dbc.Row([               
            ...
            dbc.Col([
                CustomCard([
                    dbc.Col(dcc.Graph(id='Deburring: NOK by Type per week', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}), className='p-0', style={"flexGrow": "1"}),
                ...
                dbc.Modal([
                    ...
                    dbc.ModalBody(
                        CustomCard([
                            dcc.Graph(id='Deburring: NOK by Type per week (bis)', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}, style={"flexGrow": "1"}),
        ...
        dbc.Row([
            ...
            dbc.Col([
                CustomCard([
                    dbc.Col(dcc.Graph(id='Deburring: NOK by Type per Operator', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}), className='p-0', style={"flexGrow": "1"}),
                ...
                dbc.Modal([
                    ...
                    dbc.ModalBody(
                        CustomCard([
                            dcc.Graph(id='Deburring: NOK by Type per Operator (bis)', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}, style={"margin": "auto", "display": "block"}),
            ...
            dbc.Col([
                CustomCard([
                    dbc.Col(dcc.Graph(id='Deburring: NOK by Type per Collaborator', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}), className='p-0', style={"flexGrow": "1"}),
                ...
                dbc.Modal([
                    ...
                    dbc.ModalBody(
                        CustomCard([
                            dcc.Graph(id='Deburring: NOK by Type per Collaborator (bis)', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}, style={"flexGrow": "1"}),
        ...
        dbc.Row([
            ...
            dbc.Col([
                CustomCard([
                    dbc.Col(dcc.Graph(id='Deburring: NOK by Type per Equipment', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}), className='p-0', style={"flexGrow": "1"}),
                ...
                dbc.Modal([
                    ...
                    dbc.ModalBody(
                        CustomCard([
                            dcc.Graph(id='Deburring: NOK by Type per Equipment (bis)', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}, style={"flexGrow": "1"}),
            ...
            #########################################
            # 5th Graph : Dimensional: NOK per Type #
            #########################################

            dbc.Col([
                CustomCard([
                    dbc.Col(dcc.Graph(id='Deburring: NOK per Type', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}), className='p-0', style={"flexGrow": "1"}),
                ...
                dbc.Modal([
                    ...
                    dbc.ModalBody(
                        CustomCard([
                            dcc.Graph(id='Deburring: NOK per Type (bis)', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}, style={"margin": "auto", "display": "block"}),
