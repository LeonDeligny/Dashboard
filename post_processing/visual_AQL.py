"""
Module related to the different graphs in Post Processing > Visual.
...
from pp_load import load_df_visual_AQL
...
def register_visual_AQL_callbacks(app):

    ############################################
    # 1st Graph : Visual AQL: NOK by Type per week #
    ############################################

    @app.callback(
        [
        Output('Visual AQL: NOK by Type per week', 'figure'),
        Output('Visual AQL: NOK by Type per week (bis)', 'figure')
        ],
        [
    ...
    def Update_PP_Visuel_Type_Week_Bar(selected_year, selected_week, selected_operator, selected_equipment):
        input_values = {'Year': selected_year, 'Week': selected_week, 'Operator': selected_operator, 'Equipment': selected_equipment}
        title = generate_title(input_values, "Visual AQL: NOK by Type per week")

        df_visual_AQL = load_df_visual_AQL(input_values)
        df_visual_AQL_type = extract_type(df_visual_AQL)

        filtered_df = filter_dataframe(df_visual_AQL, input_values)
        filtered_df_type = filter_dataframe(df_visual_AQL_type, input_values)
    ...
    ################################################
    # 2nd Graph : Visual AQL: NOK by Type per Operator #
    ################################################

    @app.callback(
        [
        Output('Visual AQL: NOK by Type per Operator', 'figure'),
        Output('Visual AQL: NOK by Type per Operator (bis)', 'figure')
        ],
        [
    ...
    def Update_PP_Trier_Type_Operator_Bar(selected_year, selected_week, selected_operator, selected_equipment):
        input_values = {'Year': selected_year, 'Week': selected_week, 'Operator': selected_operator, 'Equipment': selected_equipment}
        title = generate_title(input_values, "Visual AQL: NOK by Type per Operator")
    ...
    ####################################################
    # 3rd Graph : Visual AQL: NOK by Type per Collaborator #
    ####################################################

    @app.callback(
        [
        Output('Visual AQL: NOK by Type per Collaborator', 'figure'),
        Output('Visual AQL: NOK by Type per Collaborator (bis)', 'figure')
        ],
        [
    ...
    def Update_PP_Trier_Type_Collaborator_Bar(selected_year, selected_week, selected_equipment):
        ...
        title = generate_title(input_values, "Visual AQL: NOK by Type per Collaborator")
    ...
    #####################################################
    # 4th Graph : Visual AQL: NOK by Type per Equipment #
    #####################################################

    @app.callback(
        [
        Output('Visual AQL: NOK by Type per Equipment', 'figure'),
        Output('Visual AQL: NOK by Type per Equipment (bis)', 'figure')
        ],
        [
    ...
    def Update_PP_Trier_Type_Equipment_Bar(selected_year, selected_week, selected_equipment, selected_operator):
        ...
        title = generate_title(input_values, "Visual AQL: NOK by Type per Equipment")
    ...
    ########################################
    # 5th Graph : Visual AQL: NOK per Type #
    ########################################

    @app.callback(
        [
        Output('Visual AQL: NOK per Type', 'figure'),
        Output('Visual AQL: NOK per Type (bis)', 'figure')
        ],
        [
    ...
    def update_5(selected_year, selected_week, selected_equipment):
        input_values = {'Year': selected_year, 'Week': selected_week, 'Equipment': selected_equipment}
        title = generate_title(input_values, "Visual AQL: NOK per Type")
        
        df_dimensional = load_df_visual_AQL(input_values)
...
def visual_AQL_layout(operator_show):
    ...
    if operator_show:
        ...
        dbc.Row([               
            ...
            dbc.Col([
                CustomCard([
                    dbc.Col(dcc.Graph(id='Visual AQL: NOK by Type per week', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}), className='p-0', style={"flexGrow": "1"}),
                ...
                dbc.Modal([
                    ...
                    dbc.ModalBody(
                        CustomCard([
                            dcc.Graph(id='Visual AQL: NOK by Type per week (bis)', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}, style={"flexGrow": "1"}),
        ...
        dbc.Row([
            ################################################
            # 3rd Graph : Visual AQL: NOK by Type per Operator #
            ################################################

            dbc.Col([
                CustomCard([
                    dbc.Col(dcc.Graph(id='Visual AQL: NOK by Type per Operator', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}), className='p-0', style={"flexGrow": "1"}),
                ...
                dbc.Modal([
                    ...
                    dbc.ModalBody(
                        CustomCard([
                            dcc.Graph(id='Visual AQL: NOK by Type per Operator (bis)', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}, style={"margin": "auto", "display": "block"}),
            ...
            ####################################################
            # 2nd Graph : Visual AQL: NOK by Type per Collaborator #
            ####################################################

            dbc.Col([
                CustomCard([
                    dbc.Col(dcc.Graph(id='Visual AQL: NOK by Type per Collaborator', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}), className='p-0', style={"flexGrow": "1"}),
                ...
                dbc.Modal([
                    ...
                    dbc.ModalBody(
                        CustomCard([
                            dcc.Graph(id='Visual AQL: NOK by Type per Collaborator (bis)', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}, style={"flexGrow": "1"}),
        ...
        dbc.Row([
            ...
            dbc.Col([
                CustomCard([
                    dbc.Col(dcc.Graph(id='Visual AQL: NOK by Type per Equipment', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}), className='p-0', style={"flexGrow": "1"}),
                ...
                dbc.Modal([
                    ...
                    dbc.ModalBody(
                        CustomCard([
                            dcc.Graph(id='Visual AQL: NOK by Type per Equipment (bis)', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}, style={"flexGrow": "1"}),
            ...
            dbc.Col([
                CustomCard([
                    dbc.Col(dcc.Graph(id='Visual AQL: NOK per Type', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}), className='p-0', style={"flexGrow": "1"}),
                ...
                dbc.Modal([
                    ...
                    dbc.ModalBody(
                        CustomCard([
                            dcc.Graph(id='Visual AQL: NOK per Type (bis)', clickData=None, config={'scrollZoom':True, 'displayModeBar': False}, style={"margin": "auto", "display": "block"}),
